...
% Tittel velger du 
\newcommand{\temanr}{T26} % referer til det som er oppgitt på wiki-siden
\newcommand{\tematittel}{Tracking and mass surveillance in the era of Big Data} % referer til det som er oppgitt på wiki-siden 
\newcommand{\kandidatnr}{15172, 15065} % komma-separert liste med kandidatnummer for alle forfatter VIKTIG: bruk kandidatnummer og ikke studentnummer siden oppgaven skal være anonym.
\newcommand{\kandidatnrforside}{15172 \\ 15065}  %  liste med kandidatnummer for alle forfatter - her skal hver forfatter separeres med \\
\newcommand{\antallord}{5056} % antall ord må fylles inn (trenger ikke være 100% korrekt men skal gi en indikasjon; flere måter texcount, kompiler til PDF og tell, kopier i word og bruk wordcount, +++,  
